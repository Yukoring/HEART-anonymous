"""
PDDL Solver Interface (Original DELTA)

Wraps Fast Downward planner via pddlgym for solving generated PDDL problems.
Handles domain/problem file management, solver invocation, and plan extraction.
"""
