...
(define (domain fridge_then_oven)
    ...
    ; place_in: put an item into an openable container that must be open.
    ; Use for oven, fridge, microwave, etc.
    (:action place_in
    ...
    ; turn_on: turn on an appliance. Must be closed (for oven) and hand-free.
    (:action turn_on
        :parameters (?a - agent ?i - item ?r - room)
        :precondition (and
            (agent_at ?a ?r)
