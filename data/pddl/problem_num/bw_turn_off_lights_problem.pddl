(define (problem beechwood_turn_off_lights)
    ...
    (:init
        ...
        (= (item_weight floor_lamp_11) 0.0) (= (item_width floor_lamp_11) 0.330) (= (item_height floor_lamp_11) 0.750)
        (= (item_weight floor_lamp_14) 0.0) (= (item_width floor_lamp_14) 0.420) (= (item_height floor_lamp_14) 0.700)
        (= (item_weight floor_lamp_23) 0.0) (= (item_width floor_lamp_23) 0.420) (= (item_height floor_lamp_23) 0.830)
        (= (item_weight floor_lamp_29) 0.0) (= (item_width floor_lamp_29) 0.460) (= (item_height floor_lamp_29) 0.880)
