(define (problem farm_harvest_seed02)
    ...
    (:init
        ...
        (= (item_height tomato_01) 1.118) (= (item_width tomato_01) 0.162)
        ...
        (item_at tomato_03 stem_01_0) (item_pickable tomato_03) (item_rotten tomato_03)
