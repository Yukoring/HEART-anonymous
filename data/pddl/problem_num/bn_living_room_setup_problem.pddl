(define (problem benevolence_living_room_setup)
    ...
    (:objects
        ...
        sunglass_65 floor_lamp_8 wall_mounted_tv_49 sofa_10 sunglass_60 - item
    )
    ...
    (:init
        ...
        (= (item_weight floor_lamp_8) 0.0) (= (item_width floor_lamp_8) 0.290) (= (item_height floor_lamp_8) 0.715)
        (= (item_weight sofa_10) 0.0) (= (item_width sofa_10) 0.770) (= (item_height sofa_10) 0.415)
