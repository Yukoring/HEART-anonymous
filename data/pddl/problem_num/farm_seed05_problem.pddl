(define (problem farm_harvest_seed05)
    (:domain farm_harvest)
    ...
    (:init
        ...
        (= (item_height tomato_03) 0.909) (= (item_width tomato_03) 0.055)
        (item_at tomato_04 stem_02_0) (item_pickable tomato_04) (item_ripe tomato_04)
        (= (item_height tomato_04) 0.674) (= (item_width tomato_04) 0.073)
        (item_at tomato_05 stem_01_0) (item_pickable tomato_05) (item_unripe tomato_05)
