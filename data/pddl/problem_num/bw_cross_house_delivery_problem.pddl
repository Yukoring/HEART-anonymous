(define (problem beechwood_cross_house_delivery)
    ...
    (:init
        ...
        (= (item_weight bottom_cabinet_39) 0.0) (= (item_width bottom_cabinet_39) 0.609) (= (item_height bottom_cabinet_39) 0.350)
        (= (item_weight chest_8) 0.0) (= (item_width chest_8) 0.300) (= (item_height chest_8) 0.150)
        (= (item_weight notebook_119) 0.0) (= (item_width notebook_119) 0.050) (= (item_height notebook_119) 0.774)
        (= (item_weight pen_121) 0.0) (= (item_width pen_121) 0.016) (= (item_height pen_121) 0.707)
